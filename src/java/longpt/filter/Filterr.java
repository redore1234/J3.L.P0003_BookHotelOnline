...
public class Filterr implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("Filterr:DoBeforeProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session != null) {
            accountDTO = (TblAccountDTO) session.getAttribute("ACCOUNT");
        }

        String role = null;
        if (accountDTO != null) {
            role = accountDTO.getRoleId();
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("Filterr:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("Filterr(");
